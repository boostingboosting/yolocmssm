...
# model.load(r'yolov8n.pt') # loading pretrain weights
    ...
    # model = YOLO("/home/zhangquan/clg/YOLOv11-RGBT-master/runs/AntiUAV/AntiUAV-yolo11n-100epoch-batch32-RGBRGB6C-midfusion-cmssm-mi-flow/weights/last.pt")
    ...
    model.train(data=R'ultralytics/cfg/datasets/AntiUAV-rgbt.yaml',
                ...
                name='AntiUAV-yolo11n-150epoch-batch64-RGBRGB6C-midfusion-cmssm-freezergb',
                )
